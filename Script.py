...
<blockquote>Oɴᴇ Oꜰ Tʜᴇ Wᴏʀʟᴅꜱ Cᴏᴏʟᴇꜱᴛ, Bɪɢɢᴇꜱᴛ Aɴᴅ Fɪɴᴇꜱᴛ DᴀᴛᴀBᴀꜱᴇ</blockquote></b>"""
    ...
    START_TXT = """<b>Hᴇʏ └⏤‌‌‌мґ🤘, I'ᴍ SᴇᴀʀᴄʜAʀᴄ Bᴏᴛ Wɪᴛʜ Sᴜᴩᴇʀʙ Fᴇᴀᴛᴜʀᴇꜱ. 

<i>Jᴜꜱᴛ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ 💫</i></b>"""
    GSTART_TXT = """<b>Hᴇʏ └⏤‌‌‌мґ🤘, I'ᴍ SᴇᴀʀᴄʜAʀᴄ Bᴏᴛ Wɪᴛʜ Sᴜᴩᴇʀʙ Fᴇᴀᴛᴜʀᴇꜱ. 
