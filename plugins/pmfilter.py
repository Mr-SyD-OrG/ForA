...
from utils import get_size, is_req_subscribed, extract_audio_subtitles_formatted, is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings, get_shortlink, get_tutorial, send_all, get_cap
from database.users_chats_db import db
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>Hᴇʏ {user} ❄️ ,\n\nꜱᴏʀʀʏ, ʏᴏᴜ ᴄᴀɴ'ᴛ ʀᴇqᴜᴇꜱᴛ ʜᴇʀᴇ. \n<blockquote><i>ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ ɢʀᴏᴜᴘ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ 👇 ᴏʀ \nᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ɢʀᴏᴜᴩ ᴀɴᴅ ᴀᴅᴅ ᴍᴇ ᴛʜᴇʀᴇ.</i></b></blockquote>",   
    ...
    # Thanks to @CoderluffyTG for fixing this 
       ...
       await query.message.edit_text(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 Gʀᴏᴜᴘ¹', url='https://t.me/malayalam_movie_requester_bot'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        if len(message.text) < 100:
            ...
            if search.strip() == "": return await m.delete()
